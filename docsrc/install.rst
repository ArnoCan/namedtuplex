...
=========
   ...
   +==============+=============+===============================================+
   | Download     | PyPI        | https://pypi.python.org/pypi/namedtuplex      |
   +--------------+-------------+-----------------------------------------------+
   |              | Sourceforge | https://sourceforge.net/projects/namedtuplex/ |
   +--------------+-------------+-----------------------------------------------+
   |              | github.com  | https://github.com/ArnoCan/namedtuplex/       |
   +--------------+-------------+-----------------------------------------------+
   | Documents    | sourceforge | https://namedtuplex.sourceforge.io/           |
   +--------------+-------------+-----------------------------------------------+
...
For help on extensions to standard options call online context-help:
   ...
   .. parsed-literal::
      ...
      python setup.py **--help-namedtuplex**
