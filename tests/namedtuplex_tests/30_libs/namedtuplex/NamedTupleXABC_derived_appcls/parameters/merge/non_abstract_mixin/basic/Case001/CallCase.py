...
class CallUnits(unittest.TestCase):
    ...
    def testCase000(self):
        ...
        self.assertEqual(myinstance2r._asdict(), OrderedDict([('f0', 1), ('f1', 2), ('f2', 3)]))
        self.assertEqual(myinstance2l._asdict(), 'MyMixIn_asdict')
        ...
        myinstance3r = MyClassABC3right(1, 2, 3, 4)
        myinstance3l = MyClassABC3left(2, 3, 4)
